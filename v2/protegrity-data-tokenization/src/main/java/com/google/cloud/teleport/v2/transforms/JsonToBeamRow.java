...
public class JsonToBeamRow extends PTransform<PCollection<String>, PCollection<Row>> {
  ...
  final String nonTokenizedDeadLetterGcsPath;
  final SchemasUtils schema;

  public JsonToBeamRow(String nonTokenizedDeadLetterGcsPath, SchemasUtils schema) {
    this.nonTokenizedDeadLetterGcsPath = nonTokenizedDeadLetterGcsPath;
    this.schema = schema;
  }
  ...
  public PCollection<Row> expand(PCollection<String> jsons) {
    ...
    if (nonTokenizedDeadLetterGcsPath != null) {
      /*
      ...
      rows.getFailedToParseLines()
          ...
          .apply("WriteCsvConversionErrorsToGcs",
              ErrorConverters.WriteErrorsToTextIO.<String, String>newBuilder()
                  .setErrorWritePath(nonTokenizedDeadLetterGcsPath)
